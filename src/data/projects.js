const projects = [
  {
    ...
    caseStudy: {
      ...
      stats: [
        ...
        { value: '1 Eng · 1 PM · 1 Designer', label: 'Team' },
      ],
      results:
  ...
  },
  {
    ...
    caseStudy: {
      ...
      showWidgetAtTop: true,
      widgetSizesIntro: 'The widget shell that holds the analyses adapts across three primary breakpoints. Same content, three layouts.',
      widgetSizes: [
  ...
  },
  {
    ...
    heroImage: '/case-studies/manual-account/hero.webp',
    role: 'Product Designer',
    timeline: '5 Weeks',
    platform: 'Web, Mobile',
    team: ['Engineering', 'Designer'],
    ...
    caseStudy: {
      ...
      competitorMatrix: [
        { competitor: 'Kubera', domain: 'kubera', learning: 'Only app with stale data nudges. AI extraction but no visual badge distinguishing manual vs synced.' },
        { competitor: 'Portfolio Performance', domain: 'portfolio-performance', learning: '90+ bank-specific parsers. 3-step wizard preview. Desktop-only.' },
        { competitor: 'Sharesight', domain: 'sharesight', learning: 'Best preview step  -  inline row editing. CSV-only, no PDF.' },
        { competitor: 'Betterment', domain: 'betterment', learning: 'Yellow warning banner after failure. "Connect Manually Instead"  -  most explicit fallback, but framed as failure.' },
        { competitor: 'Monarch Money', domain: 'monarchmoney', learning: 'Tiered fallback after connection fails. Good discovery, too many steps.' },
        { competitor: 'Empower', domain: 'empower', learning: 'Anti-pattern: users must type "MANUAL" as a search keyword to find manual creation. Hidden by design.' },
      ],
            ...
            sections: [
              {
                ...
                media: { type: 'image', src: '/case-studies/manual-account/draft.webp', alt: 'Draft state design  -  partial upload recovery tab' },
              },
              {
      ...
      stats: [
        ...
        { value: '3 weeks', label: 'Design to ship' },
        { value: '1 Eng · 1 PM · 1 Designer', label: 'Team' },
      ],
